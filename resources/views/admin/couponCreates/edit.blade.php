...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.couponCreate.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.coupon-creates.update", [$couponCreate->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
