...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.subcriptionsCreate.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.subcriptions-creates.update", [$subcriptionsCreate->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
